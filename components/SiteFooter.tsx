    ...
    return (
      <div className="mb-3">
        ...
        <img
          ...
          className={`${size} w-auto max-w-[160px] object-contain rounded-lg bg-white/95 px-2 py-1`}
        />
      </div>
    );
  }
            ...
            {layout.showLogo && colIdx === 0 ? (
              <div className="mb-4">
                ...
                <img
                  src={contact.logoUrl || '/logo-lordenelson.jpg'}
                  alt={contact.siteName}
                  className="h-11 w-auto max-w-[150px] object-contain rounded-lg bg-white/95 px-2 py-1"
                />
              </div>
            ) : null}
            {widgets.map((w) => (
